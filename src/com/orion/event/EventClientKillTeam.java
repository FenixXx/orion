...
public class EventClientKillTeam extends Event {
     ...
     * 
     * @author Daniele Pantaleone
     * @param  attacker The <tt>Client</tt> who did the kill
     * @param  victim The <tt>Client</tt> who suffered the kill
     * @param  mod The Urban Terror <tt>Mod</tt> for this kill
     **/
    public EventClientKillTeam(Client attacker, Client victim, Mod mod) {
